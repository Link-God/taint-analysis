...
from ..helpers.core_helpers.ast_helper import Arguments
...
class FrameworkAdaptor:
    ...
    def get_func_cfg_with_tainted_args(self, definition):
        ...
        func_cfg = ControlFlowGraph.make_cfg(
            definition.node, self.project_modules, self.local_modules, definition.path, definition.module_definitions
        )
