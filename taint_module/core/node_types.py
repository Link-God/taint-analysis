...
from taint_module.helpers.visit_helper.label_visitor import LabelVisitor


class ControlFlowNode:
    def __init__(self, test, last_nodes, break_statements):
        self.test = test
        self.last_nodes = last_nodes
        self.break_statements = break_statements
...
class BlackBoxOrBuiltInNode(AssignmentNode):
...
class AssignmentCallNode(AssignmentNode):
    ...
    def __init__(self, label, left_hand_side, ast_node, right_hand_side_variables, *, line_number, path, call_node):
        ...
        Args:
            ...
            line_number(Optional[int]): The line of the expression the Node represents.
            path(string): Current filename.
            call_node(BlackBoxOrBuiltInNode or RestoreNode): Used in connect_control_flow_node.
        """
        super().__init__(label, left_hand_side, ast_node, right_hand_side_variables, line_number=line_number, path=path)
...
class ReturnNode(AssignmentNode, ConnectToExitNode):
    ...
    def __init__(self, label, left_hand_side, ast_node, right_hand_side_variables, *, path):
        ...
        """
        super().__init__(
            label, left_hand_side, ast_node, right_hand_side_variables, line_number=ast_node.lineno, path=path
        )
