...
from taint_module.core.transformer import PytTransformer
        ...
        with open(path, encoding="utf-8") as f:
            try:
                ...
                if not recursive:
                    ...
                    raise SyntaxError(
                        "The ast module can not parse the file" " and the python 2 to 3 conversion" " also failed."
                    )
    raise OSError("Input needs to be a file. Path: " + path)
